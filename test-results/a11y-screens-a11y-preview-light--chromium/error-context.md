...
- Name: a11y/screens.spec.ts >> a11y /preview (light)
- Location: tests/a11y/screens.spec.ts:15:5

# Error details

```
Error: serious/critical: color-contrast (29)
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<main class=\"min-h-screen px-6 py-10\" style=\"background:var(--color-bg-page);color:var(--color-text-primary)\">",
+                 "target": Array [
+                   "main",
+                 ],
+               },
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Buttons</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+             "relatedNodes": Array [
+               Object {
+                 "html": "<div class=\"flex flex-wrap items-start gap-3 rounded-2xl border border-border bg-card p-5\">",
+                 "target": Array [
+                   "section:nth-child(2) > .items-start.flex-wrap.bg-card",
+                 ],
+               },
+             ],
+           },
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Badges</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 3.64 (foreground color: #ffffff, background color: #b7791f, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.64 (foreground color: #ffffff, background color: #b7791f, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span class=\"inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-medium [&_svg]:size-3 bg-[var(--color-warning)] text-[var(--color-on-primary)]\">",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Card</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+             "relatedNodes": Array [
+               Object {
+                 "html": "<div class=\"rounded-2xl border border-border bg-card text-card-foreground shadow-[var(--shadow-sm)] w-full max-w-sm\">",
+                 "target": Array [
...
+         "html": "<div class=\"text-sm text-muted-foreground\">Eine kurze, ruhige Beschreibung.</div>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".gap-1\\.5 > .text-muted-foreground.text-sm",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+             "relatedNodes": Array [
+               Object {
+                 "html": "<html lang=\"de\" class=\"h-full\">",
+                 "target": Array [
+                   "html",
+                 ],
+               },
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Form field</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+                 "html": "<div class=\"flex flex-wrap items-start gap-3 rounded-2xl border border-border bg-card p-5\">",
+                 "target": Array [
+                   "section:nth-child(5) > .items-start.flex-wrap.bg-card",
+                 ],
+               },
+             ],
+           },
...
+         "html": "<p id=\"pv-name-help\" class=\"text-xs\" style=\"color:var(--color-text-muted)\">Optional — du kannst anonym bleiben.</p>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "#pv-name-help",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Search field</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Dialog</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Dropdown menu</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Toast / Notification</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Table</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+                 "html": "<div class=\"flex flex-wrap items-start gap-3 rounded-2xl border border-border bg-card p-5\">",
+                 "target": Array [
+                   "section:nth-child(10) > .items-start.flex-wrap.bg-card",
+                 ],
+               },
+             ],
+           },
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.14 (foreground color: #9e8e88, background color: #ffffff, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<th class=\"h-11 px-3 text-left align-middle text-xs font-medium text-muted-foreground\">Name</th>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "th:nth-child(1)",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.14 (foreground color: #9e8e88, background color: #ffffff, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<th class=\"h-11 px-3 text-left align-middle text-xs font-medium text-muted-foreground\">Status</th>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "th:nth-child(2)",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.14 (foreground color: #9e8e88, background color: #ffffff, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<th class=\"h-11 px-3 text-left align-middle text-xs font-medium text-muted-foreground\">Beigetreten</th>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "th:nth-child(3)",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Empty state</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+                 "html": "<div class=\"flex flex-wrap items-start gap-3 rounded-2xl border border-border bg-card p-5\">",
+                 "target": Array [
+                   "section:nth-child(11) > .items-start.flex-wrap.bg-card",
+                 ],
+               },
+             ],
+           },
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.14 (foreground color: #9e8e88, background color: #ffffff, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<p class=\"text-sm text-muted-foreground\">Warte auf deinen Gesprächspartner…</p>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "section:nth-child(11) > .items-start.flex-wrap.bg-card > .py-12.text-center.px-6 > .space-y-1 > .text-muted-foreground",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Loading state</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<h2 class=\"text-xs font-semibold uppercase tracking-wide\" style=\"color:var(--color-text-muted)\">Error state</h2>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+                 "html": "<div class=\"flex flex-wrap items-start gap-3 rounded-2xl border border-border bg-card p-5\">",
+                 "target": Array [
+                   "section:nth-child(13) > .items-start.flex-wrap.bg-card",
+                 ],
+               },
+             ],
+           },
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 3.14 (foreground color: #9e8e88, background color: #ffffff, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<p class=\"text-sm text-muted-foreground\">Wir konnten den Raum nicht laden.</p>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".py-12.text-center[role=\"alert\"] > .space-y-1 > .text-muted-foreground",
+         ],
+       },
+     ],
+     "tags": Array [
