...
- Name: a11y/screens.spec.ts >> a11y / (light)
...
+             "relatedNodes": Array [
+               Object {
+                 "html": "<div style=\"background:var(--color-bg-page);color:var(--color-text-primary)\">",
+                 "target": Array [
...
+         "html": "<p class=\"text-xs\" style=\"color:var(--color-text-muted)\">Kein Tracking. Kein Account. Keine Daten.</p>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".text-xs:nth-child(2)",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.95 (foreground color: #9e8e88, background color: #fbf7f4, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<button class=\"inline-flex items-center gap-1.5 text-xs transition-opacity hover:opacity-70 mt-1\" style=\"color:var(--color-text-muted)\">",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".inline-flex",
