...
export interface ChatInputProps {
  ...
  /** Platzhaltertext. */
  placeholder?: string
  /** Optionales Element links neben dem Eingabefeld (z.B. Statistik-Icon). */
 ...
 * @param props.leading - Optionales Element links neben dem Eingabefeld
...
export function ChatInput({
  ...
  return (
    <div
      className="pl-3 pr-4 py-2.5 flex-shrink-0"
      style={{
