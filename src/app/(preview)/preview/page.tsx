...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="space-y-3">
      ...
      <div className="flex flex-wrap items-start gap-3 rounded-2xl border border-border bg-card p-5">
        {children}
      </div>
    </section>
  )
...
export default function PreviewPage() {
  ...
  function pickPreset(p: typeof preset) {
    setPreset(p)
    applyTheme(p)
  }
      ...
      <div className="mx-auto max-w-3xl space-y-8">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {THEMES.map((t) => (
              <Button
                key={t.id}
                size="sm"
                variant={preset === t.id ? 'default' : 'outline'}
        ...
        <Section title="Form field">
          <div className="w-full max-w-sm space-y-1.5">
            <label htmlFor="pv-name" className="text-sm font-medium">
              Dein Name
            </label>
            <Input id="pv-name" placeholder="z.B. Lena" aria-describedby="pv-name-help" />
            <p id="pv-name-help" className="text-xs" style={{ color: 'var(--color-text-muted)' }}>
              Optional — du kannst anonym bleiben.
            </p>
          </div>
        </Section>
        ...
        <Section title="Toast / Notification">
          <Button variant="outline" onClick={() => toast('Link kopiert!')}>
            Info-Toast
          </Button>
          <Button variant="outline" onClick={() => toast.success('Raum erstellt.')}>
            Erfolg
          </Button>
          <Button variant="outline" onClick={() => toast.error('Etwas ist schiefgelaufen.')}>
            Fehler
          </Button>
        </Section>
        ...
        <Section title="Empty state">
          <EmptyState
            ...
            description="Warte auf deinen Gesprächspartner…"
            action={<Button size="sm">Einladen</Button>}
          />
        </Section>
        ...
        <Section title="Error state">
          <ErrorState
            ...
            description="Wir konnten den Raum nicht laden."
            action={
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Button size="sm" variant="outline" onClick={() => setBubbleKey((k) => k + 1)}>
          Bubble neu abspielen
        </Button>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Button size="sm" variant="outline" onClick={() => setDotVisible((v) => !v)}>
          Dot toggling
        </Button>
      </div>
            ...
            <>
              ...
              >
                ...
                <p className="text-sm mb-4" style={{ color: 'var(--color-text-muted)' }}>
                  Spring slide-in, damping 28, stiffness 320.
                </p>
