...
**Messung (echte Antwort, Küchen-Text):** Voll 1.517 Zeichen → ohne tote Felder 1.169 (−23%). Feld-Anteile: explanation 283 · summary 228 · suggestion 149 · mainProblem 119 · spans 77 · status 76 · priority 45 · start/end 71. **Baseline-Latenz lokal: 6.03 / 13.60 / 6.13 s (Median ~6,1s). NACHHER (Phase 1, n=13): Median ~5,0s, Best-Case 1,7–3,9s (6 von 13 unter 5s), Ausreißer bis 14s sind API-Varianz (auch in Baseline). Remap im UI smoke-verifiziert.**
...
- ✅ E2E-Feedback-Verifikation deployed — erledigt (siehe §10/1)
- ✅ Dev-Server neu gestartet — lokale Feedback-Speicherung E2E verifiziert (Doc + context, Testdoc gelöscht)
- ✅ Issues #1–#7 geschlossen
...
## 13. Fünf Pakete (2026-06-10 abends) — Issues #11–#15

**Reihenfolge:** P2(#15) → P1(#11) → P4(#12) → P3(#13) → P5(#14). Details im Plan-File; Kurzfassung:

| Issue                                                   | Paket | Inhalt                                                                                                                                                                                                                                                                                                                                                                                                                          | Status |
| ------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| [#15](https://github.com/curious93/rosenraum/issues/15) | P2    | Rosenraum-Beispiel beim Wiederöffnen aus Cache (analyzedForText) — keine Doppel-Tokens                                                                                                                                                                                                                                                                                                                                          | ⏳     |
| [#11](https://github.com/curious93/rosenraum/issues/11) | P1    | Mikro-Diktat: `/api/punctuate` (Haiku, ändert keine Wörter) beim Stopp, zentral im Hook, Zustand „Formatiere…"                                                                                                                                                                                                                                                                                                                  | ⏳     |
| [#12](https://github.com/curious93/rosenraum/issues/12) | P4    | Site-PIN **5551**: Edge-Middleware + HMAC-Cookie (30d), `/unlock`, Rate-Limit 5/15min+800ms, `config/site{pinHash,pinVersion}`, Änderung im Admin invalidiert alle Cookies                                                                                                                                                                                                                                                      | ⏳     |
